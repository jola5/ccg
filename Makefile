# Makefile madness from https://vincent.bernat.im/en/blog/2017-makefile-build-golang
...
.PHONY: install
install: all ; $(info $(M) installing executable…) @ ## Run go install, to install binary
	@go install
